...
public class LpaeActivationResponse implements BerType, Serializable {
	...
	private BerInteger lpaeActivationResult = null;
	...
	public void setLpaeActivationResult(BerInteger lpaeActivationResult) {
		this.lpaeActivationResult = lpaeActivationResult;
	}

	public BerInteger getLpaeActivationResult() {
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 0)) {
			...
			vByteCount += lpaeActivationResult.decode(is, false);

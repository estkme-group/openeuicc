...
public class GetBoundProfilePackageRequest implements BerType, Serializable {
	...
	private PrepareDownloadResponse prepareDownloadResponse = null;
	...
	public void setPrepareDownloadResponse(PrepareDownloadResponse prepareDownloadResponse) {
		this.prepareDownloadResponse = prepareDownloadResponse;
	}

	public PrepareDownloadResponse getPrepareDownloadResponse() {
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 33)) {
			...
			vByteCount += prepareDownloadResponse.decode(is, false);
